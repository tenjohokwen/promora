...
import com.softropic.promora.common.TestClockProvider;
...
import static com.softropic.promora.security.common.util.SecurityConstants.API_KEY_HEADER;
...
import static com.softropic.promora.security.jwt.api.JwtManagerImpl.CLIENT_ID;
...
public class JwtManagerImplTest {
    ...
    void setUp() {
        ...
        // Instantiate JwtManagerImpl with the mocked SecretService
        jwtManager = new JwtManagerImpl(secretService); // Assuming constructor takes SecretService
    ...
    void testCreateLoginToken_success() throws JsonProcessingException {
        ...
        try (MockedStatic<RequestMetadataProvider> mockedMetadataProvider = Mockito.mockStatic(RequestMetadataProvider.class)) {
            ...
            final Claims claims = jwtManager.extractClaims(jwt);
            assertThat(claims.getSubject()).isEqualTo(principal.getUsername());
    ...
    void testRefreshLoginToken_success() throws JsonProcessingException {
        ...
        Claims initialClaims = jwtManager.extractClaims(initialTokenString);
        ...
        final String jwt = extractCookie(mockResponse, JWT_COOKIE_NAME);
        final Claims refreshedClaims = jwtManager.extractClaims(jwt);
    ...
    void testExtendTtlOfToken_success() throws JsonProcessingException {
        ...
        Claims extendedClaims = jwtManager.extractClaims(jwt);
