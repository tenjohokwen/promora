...
INSERT INTO main."user_authority" (user_id, authority_name) VALUES (586920556720583008, 'ROLE_USER');

-- activated user (will be blocked in tests): loginId: blockme@yahoo.com p/w: admin*123!
INSERT INTO main."user" (id, created_by, created_date, last_modified_by, last_modified_date, request_id, session_id, status, dob, email, first_name, gender, lang_key, last_name, iso2_country, phone, phone_type, title, activated, activation_date, activation_key, locked, login, login_id_type, password_hash, reset_expiration, reset_key, otp_enabled) VALUES (586920556720583111, 'CUQXWCV', '2078-01-19 04:01:29.327261', 'JEHNCBEJL', '2004-07-18 12:55:21.553817', '65acab56-627d-4f49-9c0a-492d108f2799', '3754926784768', 'INACTIVE', '1978-03-19', 'blockme@yahoo.com', 'BLOCKED', 'FEMALE', 'en', 'MeLastName', 'DE', '069235478', 'MOBILE', 'QBHNOQUCFL', true, '2006-05-03 18:50:36.681611', 'TDSVYCJULU', false, 'blockme@yahoo.com', 'EMAIL', '$2a$10$Sdo/qTAcMcYaIAV6XXw3dejlsDwL93g6zb.uPUwFohPpC8q3bEg5i', null, 'HOVPXEWVX', 't');
INSERT INTO main."user_addresses" (user_id, address_line1, address_line2, address_line3, city, company_name, country, name, postal_code, state_prov) values (586920556720583111, 'IUHDLBKX', 'CUBUEWNZ', 'DULUDMIBXZ', 'DQUYPTHOW', 'TAYWNMKYLD', 'NHTTKXZWZ', 'abcdAddress', 'NKDY', 'BCVZN');
INSERT INTO main."user_authority" (user_id, authority_name) VALUES (586920556720583111, 'ROLE_USER');
...
INSERT INTO main.user_authority VALUES (675373350208068096, 'ROLE_USER');
INSERT INTO main.user_authority VALUES (675373350208068096, 'ROLE_ADMIN');
